# Portfolio de Data Science e Inteligencia Artificial

¡Bienvenido a mi portfolio! Soy un economista con un Máster en Finanzas, actualmente cursando un Máster en Inteligencia Artificial, Data Science y Business Intelligence. Este repositorio actúa como un escaparate de mis proyectos más técnicos y mi capacidad para la resolución de problemas analíticos complejos de forma autónoma.

Mi foco principal de interés e investigación reside en la **Econometría, el Machine Learning, el Deep Learning y el Deep Reinforcement Learning**. Todo el ecosistema de desarrollo, entrenamiento y evaluación de los modelos aquí expuestos está íntegramente programado en **Python**.
